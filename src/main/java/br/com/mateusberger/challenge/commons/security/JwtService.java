...
public class JwtService {
    ...
    public String generateToken(
        ...
        return Jwts
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * jwtConfigurations.getExpirationTimeInMinutes()))
    ...
    private Key getSignInKey() {
        byte[] keyBytes = Decoders.BASE64.decode(jwtConfigurations.getSecret());
